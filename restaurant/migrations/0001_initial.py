    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("show_at_index", models.BooleanField(default=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        db_index=True, max_length=100, verbose_name="음식 종류"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        db_index=True, max_length=100, verbose_name="카테고리 이름"
                    ),
                ),
                (
                    "cuisineType",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "rating_count",
                    models.PositiveIntegerField(default=0, verbose_name="좋아요 개수"),
                ),
                (
                    "start_time",
                    models.TimeField(
                        blank=True, null=True, verbose_name="영업시작시간"
                    ),
                ),
                (
                    "end_time",
                    models.TimeField(
                        blank=True, null=True, verbose_name="영업종료시간"
                    ),
                ),
                (
                    "last_order_time",
                    models.TimeField(
                        blank=True, null=True, verbose_name="라스트오더시간"
                    ),
                ),
                (
                    "region",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        db_index=True, max_length=100, verbose_name="메뉴 이름"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("title", models.CharField(max_length=100, verbose_name="리뷰 제목")),
                (
                    "author",
                    models.CharField(
                        blank=True, max_length=50, null=True, verbose_name="작성자"
                    ),
                ),
                (
                    "profile_image",
